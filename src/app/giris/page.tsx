...
export default function GirisPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setLoading(false)
      alert('Giriş başarılı! (API henüz bağlı değil)')
    }, 1000)
  }
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center', marginBottom: 32 }}>
            ...
            <p style={{ fontSize: 14, color: '#888' }}>
              Hesabına giriş yap, derslerini bul
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            ...
            <div>
              ...
              <div style={{ textAlign: 'right', marginTop: 6 }}>
                <span style={{ fontSize: 12, color: '#FF385C', cursor: 'pointer', fontWeight: 600 }}>
                  Şifremi Unuttum
                </span>
              </div>
            </div>
          ...
          <div style={{
            ...
            <span style={{ fontSize: 12, color: '#bbb' }}>veya</span>
            <div style={{ flex: 1, height: 1, backgroundColor: '#eee' }} />
          </div>
          ...
          <p style={{ textAlign: 'center', marginTop: 24, fontSize: 13, color: '#888' }}>
            Hesabın yok mu?{' '}
            <Link href="/kayit" style={{ color: '#FF385C', fontWeight: 600, textDecoration: 'none' }}>
              Kayıt Ol
            </Link>
          </p>
        </div>
