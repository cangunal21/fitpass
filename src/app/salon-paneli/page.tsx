...
function QRTab({ venueId, venueName }: { venueId: number; venueName: string }) {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
      <div>
        <h3 style={{ fontSize: 18, fontWeight: 800, color: '#1a1a1a', marginBottom: 4 }}>Müşteri QR Kodunuz</h3>
        <p style={{ fontSize: 14, color: '#888', margin: 0 }}>QR kodunu yazdırıp salonunuza asın — müşteriler okutunca doğrudan salon sayfanıza gidip rezervasyon yapar.</p>
      </div>

      <CheckInScanner venueId={venueId} />

      <div style={{ maxWidth: 420, width: '100%', margin: '0 auto' }}>
        {/* Müşteri QR — salon sayfası */}
